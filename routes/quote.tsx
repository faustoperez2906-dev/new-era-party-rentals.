        ...
        <div className="mt-6 rounded-2xl border border-primary/30 bg-card/60 p-6 md:p-8">
          ...
          <ul className="mt-4 grid gap-3 text-sm text-muted-foreground md:grid-cols-2">
            <li className="flex items-start gap-2">
              ...
              {t("Delivery fee is based on distance from our location.", "La tarifa de entrega depende de la distancia desde nuestra ubicación.")}
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
              {t("Pickup is also charged based on distance from our location.", "La recolección también tiene un cargo según la distancia desde nuestra ubicación.")}
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary">•</span>
